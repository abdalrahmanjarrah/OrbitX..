-- OrbitX XP/Levels Database Fix (منتَج: schema + hardening) — شغّله مرة واحدة في SQL Editor
-- التاريخ: 2026-09-05
-- ملفات الفحص: المستخدمون المسجلون لا يستطيعون كتابة XP (403). هذا الملف يفتح الباب:
--   بطول schema: المستوى XP، الدوال doc_owner/grant_xp... وسياسات الكتابة للمستخدمين
--   بطول hardening: حماية الخبرة المضادة للغش + سياسات سجلات الأخطاء
